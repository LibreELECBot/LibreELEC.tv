...
post_install() {
  ...
  add_fakeroot_item "chmod 4750 $INSTALL/usr/lib/dbus/dbus-daemon-launch-helper"
  add_fakeroot_item "chown 0:81 $INSTALL/usr/lib/dbus/dbus-daemon-launch-helper"
}

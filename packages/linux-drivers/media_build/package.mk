...
makeinstall_target() {
  mkdir -p $INSTALL/$(get_full_module_dir media_build)/updates/media_build
  find $PKG_BUILD/v4l/ -name \*.ko -exec cp {} $INSTALL/$(get_full_module_dir media_build)/updates/media_build \;
}
